...
def ensemble_obj(param, train_tmp, test_tmp):
    ...
    preds1 = xgboost_pred(param, train_s,labels,test_s, param['weight_inter1'])
    ...
    preds2 = xgboost_pred(param, train,labels,test, param['weight_inter2'])


    weight = param['weight']
    preds = weight * preds1 + (1-weight) * preds2
...
if __name__ == '__main__':
    ...
    param = {
        ...
        'weight_inter1': hp.quniform('weight_inter1', 1.4, 1.7, 0.01),
        'weight_inter2': hp.quniform('weight_inter2', 1.4, 1.7, 0.01),
    ...
    for k in range(kfold):
        o_f = open('hyperlogs/xgboost_sep_' + str(k) + '.log', 'wb')
